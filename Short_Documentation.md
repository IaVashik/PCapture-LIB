...
* [6. Script Events](#6-script-events)
    * [`ScriptEvent/game_event.nut`](#scripteventgameeventnut)
    * [`ScriptEvent/event_listener.nut`](#scripteventeventlistenernut)
* [7. HUD](#7-hud)
...
## 6. [Script Events](SRC/ScriptEvent/readme.md#script-events-module)


### [`ScriptEvent/game_event.nut`](SRC/ScriptEvent/readme.md#scripteventgame_eventnut)

| Class/Method | Description |
|---|---|
| [`VGameEvent(eventName: string, triggerCount: number, actionsList: function)`](SRC/ScriptEvent/readme.md#vgameeventeventname-triggercount-actionslist) | Creates a VGameEvent. |
| [`AddAction(actionFunction: function)`](SRC/ScriptEvent/readme.md#addactionactionfunction) | Adds action to event. |
| [`ClearActions()`](SRC/ScriptEvent/readme.md#clearactions) | Clears actions. |
| [`SetFilter(filterFunc: function)`](SRC/ScriptEvent/readme.md#setfilterfilterfunc) | Sets filter function. |
| [`Trigger(args: any)`](SRC/ScriptEvent/readme.md#triggerargs) | Triggers event. |
| [`ForceTrigger(args: any)`](SRC/ScriptEvent/readme.md#forcetriggerargs) | Forces trigger.  |

### [`ScriptEvent/event_listener.nut`](SRC/ScriptEvent/readme.md#scripteventevent_listenernut)

| Function | Description |
|---|---|
| [`Notify(eventName: string, ...)`](SRC/ScriptEvent/readme.md#notifyeventname) | Triggers event by name. |
| [`GetEvent(EventName: string) -> VGameEvent`](SRC/ScriptEvent/readme.md#geteventeventname) | Gets VGameEvent object. |
